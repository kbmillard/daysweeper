    ...
    <div className='space-y-6'>
      ...
      <CompanyEditableFields
        company={{
          ...
          productType,
          isSeller: Boolean(company.isSeller)
        }}
      ...
      <div className='space-y-4'>
        <div className='flex flex-wrap items-center justify-between gap-2'>
          ...
          <Link href={`/map/companies/${company.id}/set-parent`}>
            <Button size='sm'>
              <IconPlus className='mr-2 h-4 w-4' />
              Add parent company
            </Button>
        ...
        {company.Company && company.Company.id !== company.id ? (
          <ul className='space-y-2'>
            <li className='flex flex-wrap items-center justify-between gap-2'>
              <Link
                href={`/map/companies/${company.Company.id}`}
                className='text-primary font-medium hover:underline'
              >
                {company.Company.name}
              </Link>
              <div className='flex items-center gap-2'>
                <Link href={`/map/companies/${company.Company.id}`}>
                  <Button variant='outline' size='sm'>
                    View Details
                  </Button>
                </Link>
