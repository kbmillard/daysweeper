...
export default function SearchInput() {
  ...
  return (
    <div className='w-full space-y-2'>
      <Button
        variant='outline'
        className='bg-background text-neutral-800 relative h-9 w-full justify-start rounded-[0.5rem] text-sm font-medium shadow-none sm:pr-12 md:w-40 lg:w-64 dark:text-neutral-200'
