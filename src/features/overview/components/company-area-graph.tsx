    ...
    return (
      <Card className='@container/card'>
        <CardHeader>
          ...
          <CardDescription>
            New leads and pipeline status updates (company + locations)
          </CardDescription>
        </CardHeader>
  ...
  return (
    <Card className='@container/card'>
      <CardHeader>
        <CardTitle>Account Growth - Last 6 Months</CardTitle>
        <CardDescription>
          New companies by status plus site/HQ pipeline saves (each line = one status)
        </CardDescription>
      </CardHeader>
        ...
        <div className='flex w-full items-start gap-2 text-sm'>
          <div className='grid gap-2'>
            ...
            <div className='text-muted-foreground flex items-center gap-2 leading-none'>
              Includes location status changes since tracking was added
            </div>
          </div>
        </div>
      </CardFooter>
